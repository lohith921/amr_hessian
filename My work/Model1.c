/* This program computes the basis function values for each element.*/
...
/* structure for basis function ax^2+by^2+c */
struct basis{
...
/************************************************************************/
void info(){
printf("This program is used to compute basis function values for each element.");
