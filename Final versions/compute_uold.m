    ...
    for k = 1:length(o_mesh.tris)
        ...
        if ~check
            ...
            if (bool == 1) % This point lies on or inside current triangle.
                A = det([(X2' - X1') (X3' - X1')])/2;			% signed area of the whole triangle
                A1 = det([(Xg - X2') (Xg - X3')])/2;			% signed area of triangle formed by Xg, X2, X3
                A2 = det([(Xg - X1') (Xg - X3')])/2;			% signed area of triangle formed by Xg, X1, X3
                A3 = det([(Xg - X1') (Xg - X2')])/2;			% signed area of triangle formed by Xg, X2, X1
